...
return (
<div className="p-2">
<h3 className="text-3xl font-bold">About minimal-preset-test</h3>
...
<dd className="text-gray-900">minimal-preset-test</dd>
</div>
<div>
<dt className="font-medium text-gray-700">Description:</dt>
<dd className="text-gray-900">Minimal setup for simple applications</dd>
</div>
<div>
...
<dd className="text-gray-900">minimal</dd>
</div>
</dl>
</div>
</section>
