...
return (
<div className="p-2">
<h3 className="text-3xl font-bold">Welcome to minimal-preset-test!</h3>
<p className="mt-4 text-gray-600">Minimal setup for simple applications</p>
<div className="mt-8">
...
<li>✅ <strong>Database:</strong> SQLite + Drizzle ORM</li>
<li>✅ <strong>Auth:</strong> Better Auth with email</li>
