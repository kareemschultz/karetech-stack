...
saas-preset-test is built on the Better-T-Stack foundation with enhancements for full-featured saas starter with postgresql, full auth, and complete devops.
...
4. **Data Access** → Drizzle ORM → Postgresql Database
...
**Rationale**: Full-featured relational database with excellent TypeScript integration
**Alternatives Considered**: MySQL, SQLite

### ADR-002: Authentication Strategy
**Decision**: Implement authentication with email + oauth
**Rationale**: User authentication required for personalized experience and data security

### ADR-003: Testing Approach
**Decision**: Comprehensive testing with playwright + unit tests
**Rationale**: Quality assurance through automated testing ensures reliability
